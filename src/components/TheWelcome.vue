...
<template>
    <WelcomeItem>
        ...
        >
        provides you with all information you need to get
        started.
    </WelcomeItem>
    ...
    <WelcomeItem>
        ...
        <a
            ...
            rel="noopener"
            >Vue - Official</a
        >. If you need to test your components and web
        pages, check out
        <a
    ...
    <WelcomeItem>
        ...
        As an independent project, Vue relies on community
        backing for its sustainability. You can help us by
        <a
